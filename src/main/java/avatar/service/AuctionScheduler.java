...
public class AuctionScheduler {
    ...
    private void startMinuteChecking() {
        minuteTimer.scheduleAtFixedRate(new TimerTask() {
            ...
            public void run() {
                ...
                // Tính toán thời gian còn lại đến phiên đấu giá
                if (timeUntilAuction <= 59000) {
    ...
    private Calendar getNextSundayAt8PM() {//ch
        ...
        nextSunday.set(Calendar.HOUR_OF_DAY, 21);
        nextSunday.set(Calendar.MINUTE, 1);
